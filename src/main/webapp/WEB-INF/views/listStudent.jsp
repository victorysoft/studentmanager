    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <c:forEach items="${students}" var="s" varStatus="status">
            <tr>
                ...
                <td><a href="student/editStudent?id=${s.id}"><span class="glyphicon glyphicon-edit"></span> </a></td>
                <td><a href="student/deleteStudent?id=${s.id}" onclick="javascript:return del();"><span
...
<nav class="pageDIV">
    <ul class="pagination">
        <li <c:if test="${!page.hasPreviouse}">class="disabled"</c:if>>
            <a href="student/listStudent?page.start=0">
                <span>«</span>
            </a>
        </li>
        <li <c:if test="${!page.hasPreviouse}">class="disabled"</c:if>>
            <a href="student/listStudent?page.start=${page.start-page.count}">
                <span>‹</span>
            </a>
        </li>
        ...
        <c:forEach begin="0" end="${page.totalPage-1}" varStatus="status">
            ...
            <c:if test="${status.count*page.count-page.start<=30 && status.count*page.count-page.start>=-10}">
                <li <c:if test="${status.index*page.count==page.start}">class="disabled"</c:if>>
                    <a
                            href="student/listStudent?page.start=${status.index*page.count}"
        ...
        <li <c:if test="${!page.hasNext}">class="disabled"</c:if>>
            <a href="student/listStudent?page.start=${page.last}">
                <span>»</span>
            </a>
        </li>
    </ul>
...
<div class="addDIV">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <form method="post" id="addForm" action="student/addStudent" role="form">
